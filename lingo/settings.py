...
if on_appengine or os.getenv('SETTINGS_MODE') == 'prod':
    DATABASES = {
        'default': {
            ...
            'INSTANCE': 'gcdc2013-lingo:lingo',
            'NAME': 'lingodb',
        }
    }
else:
    # Running in development using local MySQL database
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'lingodb',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['gcdc2013-lingo.appspot.com']
